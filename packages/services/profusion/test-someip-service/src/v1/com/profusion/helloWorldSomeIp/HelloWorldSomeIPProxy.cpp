 ...
 */
#include <v1/com/profusion/helloWorldSomeIp/HelloWorldSomeIPProxy.hpp>
...
void HelloWorldSomeIPProxy::sayHello(std::string _name, CommonAPI::CallStatus &_internalCallStatus, std::string &_message, const CommonAPI::CallInfo *_info) {
    CommonAPI::Deployable< std::string, CommonAPI::SomeIP::StringDeployment> deploy_name(_name, &::v1::com::profusion::helloWorldSomeIp::HelloWorld_::sayHello_nameDeployment);
